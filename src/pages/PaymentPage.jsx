...
const PaymentPage = () => {
  return (
    <div className='bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 mx-auto w-full lg:w-10/12 flex justify-center mt-1'>

<div className='bg-pink-100 w-full lg:w-10/12 rounded-xl mt-9 overflow-hidden'>
...
<div className='w-full flex  justify-center align-middle mt-20'>
<div className='w-4/12 h-40 border-2 hidden lg:flex flex-col justify-center  border-red-400 mr-10 rounded-2xl'>

    <h1 className='text-2xl text-red-500 font-semibold mx-auto'>PAYMENT METHORD</h1>
   <div className='flex mx-auto mt-4'>
   <img src="public/MasterCard_Logo.svg.png" alt="" className='h-16 w-16' />
    <img src="public/visaLogo.png" alt="" className='h-16 ml-4 w-16' />

    <img src="public/paypal-logo.png" alt="" className='h-16 ml-4 w-16' />  
    </div>  </div>
    {/* payment headings */}
    
    <div className='lg:w-6/12 w-full  bg-gray-100 my-auto border-[1px] border-red-300 rounded-xl flex justify-center flex-wrap'>
